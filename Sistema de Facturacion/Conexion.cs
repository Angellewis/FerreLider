    ...
    class Conexion
    {
        ...
        public void GUARDAR_USUARIO(Usuarios users) {
            ...
            try
            {
                ...
                {
                    cmd = cn.CreateCommand();
                    cmd.CommandText = ("insert into Usuario values (@Email, @Nombre_Completo, @Usuario, @Contrasena, @Fecha)");
                ...
                metodos.Mensajes("Ha ocurrido un error, intente nuevamente","error");
        ...
        public void EDITAR_USUARIO(Usuarios us) {
            ...
            {
                cmd = cn.CreateCommand();
                cmd.CommandText = ("update Usuario set Email=@Email, Nombre_Completo=@Nombre, Usuario=@Usuario, Contrasena=@Contrasena where Id_Usuario=@id");
