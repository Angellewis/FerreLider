...
namespace Sistema_de_Facturacion
{
    public partial class frmMenu : Form
    {
        ...
        public void usuariostab() {
            ...
            cn.SQL(dgvusuarios, "select Id_Usuario, Nombre_Completo, Email, Usuario, Fecha from Usuario");
        ...
        private void frmMenu_Load(object sender, EventArgs e)
        {
            ...
            this.Text = "MENU - [" + LoadData.Nombre + "]";
        ...
        private void txtbusquedausuario_TextChanged(object sender, EventArgs e)
        {
            ...
            //cn.BUSQUEDAUSERS(dgvusuarios, txtbusquedausuario.Text.ToString(), "Usuario", "Nombre_Completo", 15);
        }
        ...
        public void timerdashload() {
            ...
            if (num == 3)
            {
                ...
                try
                {
                    ...
                    metodos.Mensajes("No se han realizado ventas hoy :(","error");
